export const queryKeys = {
  ...
  attendManagerShiftConfirmStatus: (year: number, month: number, week: number) =>
    ['attend-manager-shift-confirm-status', year, month, week] as const,
  attendManagerShiftMonth: (year: number, month: number) =>
    ['attend-manager-shift-month', year, month] as const,
