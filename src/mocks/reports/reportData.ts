...
export type { AttendanceEvent, AttendanceRecord, ReportEmployee } from '@/types/domain';
...
// 조직 변경 이력을 날짜 기준으로 반영해 해당 일자의 소속 정보를 반환합니다.
...
const recordInputs: AttendanceRecordInput[] = [
  {
    ...
    checkOut: '13:00',
    events: [
      { codeId: 'LATE', detail: '09:05 출근' },
      { codeId: 'HALF_PM', detail: '13:00 반차퇴근' },
    ],
  },
  ...
  { id: 3, employeeId: 4, date: '2026-06-02', events: [{ codeId: 'ANNUAL', detail: '연차 사용' }] },
  {
    ...
    checkIn: '09:00',
    checkOut: '17:20',
    events: [{ codeId: 'EARLY_LEAVE', detail: '17:20 퇴근' }],
  },
  {
    id: 5,
    employeeId: 9,
    ...
    checkIn: '09:00',
    checkOut: '18:00',
    events: [{ codeId: 'REMOTE_WORK', detail: '종일 재택' }],
  },
  { id: 6, employeeId: 2, date: '2026-06-05', events: [{ codeId: 'ABSENT', detail: '미출근' }] },
  {
    ...
    checkIn: '14:00',
    checkOut: '18:00',
    events: [{ codeId: 'HALF_AM', detail: '14:00 출근' }],
  },
  {
    id: 8,
    employeeId: 5,
    ...
    checkIn: '09:12',
    checkOut: '18:00',
    events: [{ codeId: 'LATE', detail: '09:12 출근' }],
  },
  {
    id: 9,
    employeeId: 11,
  ...
  { id: 11, employeeId: 3, date: '2026-06-12', checkIn: '08:58', checkOut: '18:04', events: [] },
  {
    ...
    checkIn: '09:08',
    checkOut: '18:02',
    events: [{ codeId: 'LATE', detail: '09:08 출근' }],
  },
  {
    id: 13,
    employeeId: 12,
    ...
    checkIn: '09:00',
    checkOut: '13:00',
    events: [{ codeId: 'HALF_PM', detail: '13:00 반차퇴근' }],
  },
  { id: 14, employeeId: 1, date: '2026-06-17', checkIn: '08:54', checkOut: '18:03', events: [] },
  {
    ...
    checkIn: '09:00',
    checkOut: '17:35',
    events: [{ codeId: 'EARLY_LEAVE', detail: '17:35 퇴근' }],
  },
  {
    id: 16,
    employeeId: 6,
    ...
    checkIn: '09:10',
    checkOut: '18:00',
    events: [{ codeId: 'LATE', detail: '09:10 출근' }],
  },
  ...
  { id: 19, employeeId: 7, date: '2026-06-23', checkIn: '09:00', checkOut: '18:10', events: [] },
  {
    ...
    checkIn: '09:04',
    checkOut: '18:00',
    events: [{ codeId: 'LATE', detail: '09:04 출근' }],
  },
];
